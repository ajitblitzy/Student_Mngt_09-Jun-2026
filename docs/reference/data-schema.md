...
- **Subjects:** [Readme.md:L181-L187]
- **Total denominator:** [Readme.md:L207]
- **Grade thresholds:** [Readme.md:L209-L221]
...
inside `generateReport()` [Readme.md:L181-L187]. Each value is read by element ID from a
matching `<input type="number">` field [Readme.md:L64-L68].

| Subject | Input ID | Type | Default (blank/falsy field) |
|---|---|---|---|
| Maths | `#maths` [Readme.md:L64] | `number` | `0` [Readme.md:L182] |
| Science | `#science` [Readme.md:L65] | `number` | `0` [Readme.md:L183] |
| English | `#english` [Readme.md:L66] | `number` | `0` [Readme.md:L184] |
| History | `#history` [Readme.md:L67] | `number` | `0` [Readme.md:L185] |
| Computer | `#computer` [Readme.md:L68] | `number` | `0` [Readme.md:L186] |
...
default for a blank/falsy field is `0` [Readme.md:L182-L186]. The guard defaults only
...
|---|---|---|
| Number of subjects | `5` | Fixed set — Maths, Science, English, History, Computer [Readme.md:L181-L187] |
...
| Total denominator | `500` | Divisor used to compute the percentage [Readme.md:L207] |
...
[Readme.md:L181-L207]. The per-subject maximum of `100` is therefore an *intended domain
...
Grades are assigned by an ordered `if / else-if` cascade [Readme.md:L209-L221]. The ranges
...
The default grade `'F'` is initialized at [Readme.md:L209] and is retained whenever every
...
[Readme.md:L181-L221]. There is **no UI control, configuration file, environment variable, or
